...
import BrgyServiceDetails from '../../brgy.service.details';
import BrgyServiceForms from '../../brgy.service.forms';
import BrgyServiceDocuments from '../../brgy.service.documents';
import BrgyRequests from '../../brgy.requests';
import BrgyArchivedRequests from '../../brgy.archived.requests';

const MainTabs = () => {
    const tabs = [
        { tabName: 'Service Details', badge: null },
        { tabName: 'Service Forms', badge: null },
        { tabName: 'Service Documents', badge: null },
        { tabName: 'Service Requests', badge: 4 },
        { tabName: 'Archived Requests', badge: 5 },
    ];
    const tabContent = [
        { content: <BrgyServiceDetails /> },
        { content: <BrgyServiceForms /> },
        { content: <BrgyServiceDocuments/> },
        { content: <BrgyRequests /> },
        { content: <BrgyArchivedRequests /> },
    ]
