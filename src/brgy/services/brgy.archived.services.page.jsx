...
const BrgyArchivedServicesPage = () => {
    ...
    const Layout = () => (
        <div>
            ...
            <div className='mb-3 flex justify-between items-end'>
                <h2 className="flex flex-col items-start text-3xl font-medium lg:items-center md:flex-row text-slate-700">Archive Service Management</h2>
            </div>
            {/* TABLE OR TABS */}
...
export default BrgyArchivedServicesPage